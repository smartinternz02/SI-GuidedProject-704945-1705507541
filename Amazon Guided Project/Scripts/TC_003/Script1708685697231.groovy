...
WebUI.click(findTestObject('Object Repository/Page_Online Shopping site in India Shop Onl_10c5f3/div_da vinci code'))

WebUI.click(findTestObject('Object Repository/Page_Amazon.in  da vinci code/span_The Da Vinci Code (Abridged Edition) P_4896eb'))

WebUI.switchToWindowTitle('The Da Vinci Code (Abridged Edition) [Paperback] Brown, Dan : BROWN DAN: Amazon.in: Books')

WebUI.click(findTestObject('Object Repository/Page_The Da Vinci Code (Abridged Edition) P_54f610/input_Quantity_submit.add-to-cart'))

WebUI.click(findTestObject('Object Repository/Page_Amazon.in Shopping Cart/span_Orders_nav-cart-icon nav-sprite'))
